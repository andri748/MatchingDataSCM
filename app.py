...
ni = connect.df_niel.rename(columns={"AIRING_DATE":"AIRING_DATE_NIEL","AIRING_TIME":"AIRING_TIME_NIEL","PROGRAM_TITLE":"PROGRAM_NAME_NIEL",
...
print(hasil_tmp)
#hasil_tmp.to_excel('coba1.xlsx')

# create_table = """CREATE TABLE MATCHING_IVMtes(AIRING_DATE_GEN DATE,
...
#con = cx_Oracle.connect('ivm_read','ivm_read',cx_Oracle.makedsn('172.17.32.63',1521,'GENIVM'))
con = cx_Oracle.connect('IVM_READ','ivm_read',cx_Oracle.makedsn('172.17.33.103',1521,'GENIVM'))
cur = con.cursor()
#cur.execute("DROP TABLE MATCHING_ivm")
